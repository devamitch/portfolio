    ...
    projects: [
      {
        ...
        description:
          "Built agentic AI system for automated patient workflows. Implemented RAG pipelines for medical knowledge retrieval. IntegratedLLMs into mobile applications. HIPAA-compliant blockchain-based health records.",
