    ...
    <div style={{ overflowX: "auto" }}>
      <div style={{ minWidth: 680 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 6, marginTop: 8 }}>
          <span style={{ fontSize: 9, color: "rgba(201,168,76,.45)", fontFamily: MONO }}>Less</span>
          {cols.map((c, i) => (
            <div key={i} style={{ width: 10, height: 10, borderRadius: 2, background: c }} />
          ))}
          <span style={{ fontSize: 9, color: "rgba(201,168,76,.45)", fontFamily: MONO }}>More</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section id="github" style={{ padding: "80px 0", background: COLORS.bg2 }}>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px" }}>
        ...
        <SH l1="Shipping code." l2="Every. Single. Day." size="clamp(32px,4vw,56px)" />
        ...
        >
          ...
          >
            <div>
              ...
              >
                <Github size={12} color={COLORS.gold} />
                GitHub Activity
              </div>
              <div
                style={{
              ...
              >
                2,029{" "}
                <span style={{ color: COLORS.gold }}>contributions</span>
              </div>
              <div
                style={{
                  fontSize: 10,
